...
Returns the network, gRPC URL, and sponsor address.

```json
{
  "network": "testnet",
  "grpcUrl": "https://sui-testnet.mystenlabs.com:443",
  "address": "0x..."
}
```
...
|---|---|---|---|
| `waitForExecution` | `boolean` | `false` | Wait for transaction finality before responding |
